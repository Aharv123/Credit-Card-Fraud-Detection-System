...
def get_user_input_and_predict():
    ...
    # Output result based on probability threshold
    THRESHOLD = 0.2  # You can adjust this for more or less strictness
    if probability[0] >= THRESHOLD:
        print(f"\n⚠️ Fraud detected! Probability: {probability[0]:.4f}")
    else:
